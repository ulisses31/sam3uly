...
try:
    ...
    HAS_TRITON = False
    import warnings
    warnings.warn("Triton not available. EDT operations will not be supported.", UserWarning)
...
if HAS_TRITON:
    ...
    def edt_triton(data: torch.Tensor):
        raise NotImplementedError("Triton is not available. EDT operations are not supported on this platform.")
